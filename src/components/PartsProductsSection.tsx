      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <p className={`text-base sm:text-lg leading-relaxed ${isDarkMode ? 'text-slate-300' : 'text-slate-600'}`}>
            Browse verified stock for screens (Incell JH vs DD OLED), batteries, back glasses, camera modules, and genuine Apple accessories with walk-in testing.
          </p>
        </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {filteredParts.slice(0, searchQuery ? undefined : displayLimit).map((part) => {
                ...
                const displayImage = isScreen ? getScreenDisplayImage(part, currentTier) : customProductImage;
                            ...
                            <img
                              ...
                              onError={(e) => {
                                ...
                                if (isScreen) {
                                  ...
                                  // If image fails, hide the image container gracefully
                          ...
                          {hasBothTiers ? (
                            <>
                              ...
                              <div className="grid grid-cols-2 gap-1.5">
                                ...
                                <button
                                  ...
                                  aria-label={`Select DD OLED screen for ${part.name}`}
                            ...
                            <div className="flex items-center justify-between px-1.5 py-1">
                              <div className="flex items-center gap-2">
                                ...
                                <span className={`text-xs font-bold ${isDarkMode ? 'text-slate-200' : 'text-slate-800'}`}>
                                  Quality: <span className="text-cyan-400">DD OLED Display</span>
                                </span>
                              </div>
